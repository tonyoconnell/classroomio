...
Here we will update our email configurations, to prevent supabase from sending confirmation emails on signup. This is because we don't have email confirmation setup on ONE, this feature will come later. If you don't disable it, you won't be able to signup into the application.
